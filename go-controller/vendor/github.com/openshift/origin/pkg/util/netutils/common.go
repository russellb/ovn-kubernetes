...
func IPToUint64(ip net.IP) (uint64, uint64) {
...
func Uint64ToIP(upper, lower uint64) net.IP {
	ip := make([]byte, 16)
	binary.BigEndian.PutUint64(ip[:8], upper)
	binary.BigEndian.PutUint64(ip[8:], lower)
	return net.IP(ip)
}
